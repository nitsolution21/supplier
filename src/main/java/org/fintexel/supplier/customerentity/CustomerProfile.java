...
public class CustomerProfile {
	...
	@Column(name = "REGISTRATION_TYPE") private String registrationType;
	...
	public String toString() {
		return "CustomerProfile [id=" + id + ", cId=" + cId + ", customerName=" + customerName + ", customerContact1="
	...
	public CustomerProfile(Long id, Long cId, String customerName, String customerContact1, String customerContact2,
			String registrationType, String registrationNo, String status, String createdBy, Date createdOn,
