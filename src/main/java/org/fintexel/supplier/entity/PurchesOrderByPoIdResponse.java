...
public class PurchesOrderByPoIdResponse {
	private Long POId;
	private int cId;
	...
	private List<InvoceItem> purchesOrderItems;

	public PurchesOrderByPoIdResponse() {
		super();
		// TODO Auto-generated constructor stub
	}

	public PurchesOrderByPoIdResponse(Long pOId, int cId, String poNumber, Long userId, String supplierCode,
			String supplierName, Long departmentId, String departmentName, Long cusAddrId, String cusAddrText,
			Long supAddrId, String supAddrText, Long contractId, int contractTerms, String comment, Long shipToId,
			String shipToText, Long billToId, String billToText, Long deliveryToId, String deliveryToText,
			String curType, float amount, String status, String statusComment, String createdBy, Date createdOn,
			int isDeleted, double totalGross, double totalTax, double totalSubTotal, double totalAmountWithoutTax,
			String invoiceNumber, String registrationNumber, String customerName, String invoiceStatus,
			List<InvoceItem> purchesOrderItems) {
		super();
		POId = pOId;
		this.cId = cId;
	...
	public String toString() {
		return "PurchesOrderByPoIdResponse [POId=" + POId + ", cId=" + cId + ", poNumber=" + poNumber + ", userId="
				+ userId + ", supplierCode=" + supplierCode + ", supplierName=" + supplierName + ", departmentId="
				+ departmentId + ", departmentName=" + departmentName + ", cusAddrId=" + cusAddrId + ", cusAddrText="
	...
	public List<InvoceItem> getPurchesOrderItems() {
		return purchesOrderItems;
	}

	public void setPurchesOrderItems(List<InvoceItem> purchesOrderItems) {
		this.purchesOrderItems = purchesOrderItems;
	}
