...
public class InventoryController {
	...
	public ItemCategory updateCategory(@PathVariable() Long id, @RequestBody ItemCategory itemCategory, @RequestHeader(name = "Authorization") String token) {
	...
	public ItemSubCategory updateSubCategory(@PathVariable() Long id,@RequestBody ItemSubCategory itemSubCategory, @RequestHeader(name = "Authorization") String token) {
